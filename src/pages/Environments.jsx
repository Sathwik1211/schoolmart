    ...
    <main className="min-h-screen bg-gray-50 pt-16 pb-10">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <section className="pt-4 pb-6 grid grid-cols-1 md:grid-cols-6 lg:grid-cols-4 gap-3 items-stretch h-auto">
           {/* BIG TEXT BLOCK */}
           <div className="md:col-span-3 lg:col-span-2 bg-white rounded-[20px] p-8 flex flex-col justify-center border border-gray-200 shadow-sm relative overflow-hidden group min-h-[300px]">
           ...
           {/* SUB-BLOCK 1 - ECO */}
           <div className="md:col-span-2 lg:col-span-1 bg-white rounded-[20px] p-6 border border-gray-200 shadow-sm flex items-center justify-between group hover:border-sm-blue transition-colors">
           ...
           <div className="columns-1 md:columns-3 gap-4 space-y-4">
              {[
                ...
                { t: 'Biophilic Design', c: 'Nature', img: 'https://images.unsplash.com/photo-1518133910546-b6c2fb7d79e3?w=600&q=80', h: 'h-[350px]' },
                 ...
                 <div key={i} className={`break-inside-avoid relative overflow-hidden rounded-[20px] shadow-sm group cursor-pointer ${work.h} border border-gray-200`}>
        ...
        <section className="py-12 grid grid-cols-1 lg:grid-cols-2 gap-8 items-center border-t border-gray-100 mt-6">
           <div className="bg-white p-12 rounded-[30px] border border-gray-200">
