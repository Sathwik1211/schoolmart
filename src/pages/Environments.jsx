    ...
    <main className="min-h-screen bg-gray-50 pt-6 pb-4">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <section className="pt-4 pb-6 grid grid-cols-1 md:grid-cols-6 lg:grid-cols-4 gap-3 items-stretch h-auto">
           ...
           {/* SUB-BLOCK 1 - ECO */}
           <div className="md:col-span-2 lg:col-span-1 bg-white rounded-[20px] p-6 border border-gray-300 shadow-sm flex items-center justify-between group hover:border-sm-blue transition-colors">
