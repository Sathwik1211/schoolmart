          ...
          <div className="w-full lg:w-72 space-y-4">
            ...
            <div className="bg-white rounded-2xl overflow-hidden shadow-sm border border-gray-100">
              <div className="bg-cyan-500 px-4 py-2.5">
                <h3 className="text-white font-semibold text-center uppercase tracking-wide text-sm">Resources</h3>
              </div>
              <div className="p-3 space-y-0.5">
                {[
                  ...
                  <Link
                    key={item}
                    to="#"
                    className="block text-xs text-gray-600 hover:text-sm-blue transition-colors duration-200 py-1.5 border-b border-gray-50 last:border-0"
                  >
                    {item}
                  </Link>
                ))}
