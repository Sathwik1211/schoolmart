    ...
    <div className="bg-[#0057A8] text-white py-1.5 px-4 border-b border-white/5 relative z-[70]">
      <div className="max-w-7xl mx-auto flex items-center justify-between gap-1">
        ...
        <div className="flex items-center gap-3 md:gap-6">
          <a href="mailto:info@schoolmart.in" className="flex items-center gap-1.5 hover:text-sm-yellow transition-all text-[9px] font-black uppercase tracking-wider">
            <Mail size={10} className="text-sm-yellow" />
            <span className="hidden xs:inline">info@schoolmart.in</span>
          </a>
          <a href="tel:+919966109191" className="flex items-center gap-1.5 hover:text-sm-yellow transition-all text-[9px] font-black uppercase tracking-wider">
        ...
        <div className="flex items-center gap-4">
          <div className="flex items-center gap-3 text-[9px] font-black uppercase tracking-widest bg-white/10 px-3 py-1.5 rounded-full border border-white/10 group overflow-hidden">
          ...
          {/* Social icons only on desktop - save space */}
